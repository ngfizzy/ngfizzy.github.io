---
title: "You Don't Need Axios"
date: 2023-10-24
description: "You don't need Axios, well, for most use cases. The web is maturing, and the days of Axios are..."
---

<p>You don't need Axios, well, for most use cases. The web is maturing, and the days of Axios are ending.</p>

<h2>
  <a name="why-we-needed-axios" href="#why-we-needed-axios">
  </a>
  Why we needed Axios
</h2>
...
<h2>
  <a name="use-fetch-instead" href="#use-fetch-instead">
  </a>
  Use fetch() Instead
</h2>
...
<h3>
  <a name="get-request-using-fetch" href="#get-request-using-fetch">
  </a>
...
<h3>
  <a name="post-request-using-fetch" href="#post-request-using-fetch">
  </a>
...
<h3>
  <a name="uploading-files" href="#uploading-files">
  </a>
  Uploading Files
</h3>
...
<h2>
  <a name="the-whataboutisms" href="#the-whataboutisms">
  </a>
  The Whataboutisms
</h2>

<h3>
  <a name="what-about-request-and-response-interceptors" href="#what-about-request-and-response-interceptors">
  </a>
...
<h4>
  <a name="edit-24-oct-2023-more-on-intercepting-requests" href="#edit-24-oct-2023-more-on-intercepting-requests">
  </a>
...
<h3>
  <a name="what-about-timeouts" href="#what-about-timeouts">
  </a>
  What About Timeouts
</h3>
...
<h3>
  <a name="what-about-javascript-in-the-backend-aka-nodejsdenobun" href="#what-about-javascript-in-the-backend-aka-nodejsdenobun">
  </a>
...
<h3>
  <a name="what-about-a-progress-update-for-large-file-uploads" href="#what-about-a-progress-update-for-large-file-uploads">
  </a>
